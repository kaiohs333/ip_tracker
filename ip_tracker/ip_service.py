...
# (As constantes de OCR foram movidas para app_gui.py)
...
class IPService:
    ...
    #
    # A FUNÇÃO 'process_paste_event' FOI REMOVIDA DAQUI.
    # A lógica agora está em app_gui.py (_handle_paste e _run_ocr_task)
    #
    ...
    def handle_register_flow(self, ip: str, mobile_code: str, record_type: str, show_warning_func, ask_yes_no_func, show_info_func, show_error_func):
        ...
        from .ui_components import PasteEnabledInputDialog # Import local
    ...
    def handle_search_flow(self, show_info_func, show_error_func) -> dict | None:
        ...
        if ip_to_search:
            ...
            if result:
                # Código corrigido (sem \ extra e usando \n)
                info = (
